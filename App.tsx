...
const App: React.FC = () => {
  ...
  const footerLinks = (
    <div className={`text-sm ${theme === 'dark' ? 'text-nothing-gray-light' : 'text-day-gray-dark'} opacity-80`}>
        <p>Made with 🤍❤️🖤 for <a href="https://nothing.community/" target="_blank" rel="noopener noreferrer" className={linkClasses}>Nothing Community</a> by <a href="https://nothing.community/u/Udaign" target="_blank" rel="noopener noreferrer" className={linkClasses}>Sudheer</a>.</p>
        <p>For feedback and feature requests, join the <a href="https://nothing.community/d/38047-introducing-matrices-a-handy-utility-to-create-matrix-styled-imagery" target="_blank" rel="noopener noreferrer" className={linkClasses}>discussion</a>. For contact, <a href="mahadevusudheer274@gmail.com" className={linkClasses}>email me</a>.</p>
    </div>
  );
